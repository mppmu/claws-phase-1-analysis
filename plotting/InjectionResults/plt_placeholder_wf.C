...
void plt_placeholder_wf()
{
    ...
    TH1F* axis_bottom = (TH1F*) axis->Clone("axis_bottom");
    axis_bottom->GetXaxis()->SetTitleOffset(2.4);
    ...
    can->SaveAs("./InjectionResults/placeholder_wf.pdf");
    can->SaveAs("./InjectionResults/placeholder_wf.png");
    can->SaveAs("./InjectionResults/placeholder_wf.eps");
    can->SaveAs("./InjectionResults/placeholder_wf.jpg");
