...
{
    TFile* rfile = new TFile("./run_900122_systematics_ph1v4.root");
    ...
    cout << "Max 1: " << 1-langaus1->GetMaximumX() << endl;
    cout << "Max 2: " << 1-langaus2->GetMaximumX() << endl;
    cout << "Max 3: " << 1-langaus3->GetMaximumX() << endl;
    cout << "Max 4: " << 1-langaus4->GetMaximumX() << endl;
