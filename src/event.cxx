...
boost::filesystem::path Event::GetPath(string type)
{
...
std::vector<Rate > PhysicsEvent::GetRates()
{
...
boost::property_tree::ptree PhysicsEvent::GetPT()
{
		return pt_;
};
...
void AnalysisEvent::SaveEvent(boost::filesystem::path dst, string prefix)
{
		...
		boost::filesystem::path output = dst;
